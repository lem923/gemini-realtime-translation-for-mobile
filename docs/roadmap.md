...
> 最后更新：2026-08-13。`0.19.0` Android 预发布候选已完成签名包、API 26/36 与真实 Gemini 双向验证；`0.20.0` 开发基线已修复真机反馈的会话保持问题（音频中断不再停流、采集意外结束自动恢复、服务端静音窗口缩短为 500 ms）；当前阶段：Android 真机与声学硬化。
